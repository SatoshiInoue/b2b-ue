...
|---|---|---|---|---|
| `rootPath` | 0 | text | `/en/news` | EDS path whose children to list |
...
The `listOrder` property must be added to the `&base-site` anchor so all language indices inherit it:
